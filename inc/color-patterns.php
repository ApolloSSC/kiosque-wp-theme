 ...
 */
function kiosque_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Kiosque default saturation level.
	 *
	 * @since Kiosque 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'kiosque_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.kiosque-front-page) .entry-title,
...
.colors-custom .kiosque-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.kiosque-front-page .panel-content .recent-posts article,
...
.colors-custom.kiosque-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Kiosque custom colors CSS.
	 *
	 * @since Kiosque 1.0
	 *
	 ...
	 */
	return apply_filters( 'kiosque_custom_colors_css', $css, $hue, $saturation );
}
